...
namespace Presentacion
{
    public partial class FrmGestionarCategorias : Form
    {
        ...
        private void btnProbarCategoria_Click(object sender, EventArgs e)
        {
            ...
            //Agregar las instancias de la clase categorian a la lista de categorias
        ...
        private void btnCrearCategoría_Click(object sender, EventArgs e)
        {
            //1-Capturar los valores ingresados por el usuario en los texbox
            string nombre = txtNombre.Text;
            string descripcion = txtDescripcion.Text;

            //2-Crear una instancia de la clase Categoria
